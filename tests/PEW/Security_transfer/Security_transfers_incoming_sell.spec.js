...
test('test @FP-TC-348', async ({ page }) => {
  await page.goto('http://192.168.137.2:7080/realms/prospero/protocol/openid-connect/auth?response_type=code&client_id=rest-api-client&scope=openid%20profile%20email&state=SgG4rJ5JbY01WZEERFdfQ9FfmGARlh7qUqSMUsBETQs%3D&redirect_uri=http://192.168.137.2:8800/login/oauth2/code/keycloak&nonce=u8qVXBy4rEccVPvvZCm3xeXap9NGvJv4GYhxRGIzm-k&code_challenge=D8AbdVuXp-4GUZR5oBpphnRbd-hZCWX_hnWeJQE3H34&code_challenge_method=S256');
  ...
  await page.getByRole('cell', { name: 'INCOMING SECURITIES TRANSFER' }).click();
